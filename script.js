...
function outputUpdate(e) {
  ...
  function cardvalue(a) {
    ...
    document
      ...
      .scrollTo({
        left:
          (Number(document.getElementsByClassName('screen')[0].scrollWidth) /
            5) *
          a,
        behavior: 'smooth',
      });
...
focus_skill = (e) => {
  ...
  if (a.id == 'close') {
    ...
    e.childNodes[1].childNodes[3].childNodes[0].className =
      'uil uil-angle-down';
...
function formdata() {
  ...
  var maillink = (document.getElementById(
    'maillink'
  ).href = `mailto:thapasebak059@gmail.com.com?subject=Contact by ${name}. &body=${body}`);
}
